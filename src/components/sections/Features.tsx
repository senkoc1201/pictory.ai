  ...
  return (
    <section className="py-16" style={{ background: '#ede4f6' }}>
      <div className="max-w-3xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-10" style={{ color: '#2d3a3a' }}>
        ...
        <div className="flex flex-col space-y-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-center h-full" style={{ width: '450.875px', height: '450.875px' }}>
                <iframe
                  src={feature.video}
                  className="rounded-2xl shadow-md w-full h-full object-cover bg-black border-none"
